...
$db = new Database();
$laptop = $db->getLaptopById($_GET['id'] ?? '');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = $db->pdo->prepare("UPDATE Laptops SET name = :name, categoryId = :categoryId, price = :price, description = :description WHERE id = :id");
    $query->execute([
        'name' => $name,
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <section class="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
        ...
        <h2 class="text-xl font-semibold text-gray-800 mb-4">Edit Laptop</h2>
